...
shinyUI(fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      sliderInput("iter", label = h5("Number of Iterations"), min = 10, max = 500,value = 50, step = 10),
      ...
      sliderInput("repr_rate", label = h5("Reproduction Rate"), min= 1, max= 50, value = 10, step = 5),
    ...
    mainPanel(
      ...
      tabsetPanel(
        tabPanel('Encounters Plot, click Start',
                 helpText("Hover over each point to show the ID of the corresponding organism"),br(),
                 plotlyOutput("encounter")),
                
        tabPanel('gvis Motion Chart, click Start',
                 helpText("This plot animates the abundance of the species over cycles and the convergence
                          of the population towards one strategy.
                          Adjust the speed of motion next to play button. Select x-axis, y-axis and 
        ...
        tabPanel('Scatter Plot, click Start', 
                 helpText("This plot shows the evolution of species over time.
                          Hover the mouse over the dots to show the dialect of the corresponding organism"),
                 br(),
