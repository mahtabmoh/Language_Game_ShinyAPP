  ...
  sidebarLayout(
    ...
    mainPanel(
      ...
      h4("This game simulates interactions between the members of a population of organisms that are assigned some randome characteristics.
        ...
        The nature of the interactions is defined by the strategies of organisms. A group of organisms belonging to the same strategy is referred to as "Species"."),
